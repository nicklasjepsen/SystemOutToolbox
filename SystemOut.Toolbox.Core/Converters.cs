...
namespace SystemOut.Toolbox.Core
{
    ...
    {
        // Taken from http://stackoverflow.com/questions/5996320/net-timezoneinfo-from-olson-time-zone 
        // Added more entries from unicode.org
        ...
        private static readonly Dictionary<string, string> OlsonWindowsTimes = new Dictionary<string, string>
            {
                ...
                {"Antarctica/South_Pole Antarctica/McMurdo", "New Zealand Standard Time"},
                ...
                {"America/Manaus America/Boa_Vista America/Eirunepe America/Porto_Velho America/Rio_Branco", "SA Western Standard Time"},
                ...
                {"Asia/Vladivostok Asia/Sakhalin", "Vladivostok Standard Time"},
